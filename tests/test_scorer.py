...
class TestScoringFunctions(unittest.TestCase):
    ...
    def test_topic_score_matches_keywords(self):
        ...
        score, _ = calculate_topic_score(self.article_recent, self.config['topics'])
    ...
    def test_topic_score_no_match(self):
        ...
        score, _ = calculate_topic_score(article, self.config['topics'])
...
class TestScorerEdgeCases(unittest.TestCase):
    ...
    def test_article_with_no_title(self):
        ...
        score, _ = calculate_topic_score(article, config['topics'])
