...
def add_security_headers(response):
    ...
    # CSP: Allow inline scripts/styles (unsafe-inline) as required by current templates
    # In a future refactor, move scripts/styles to external files to enable stricter CSP
